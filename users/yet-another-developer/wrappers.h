...
#define _________________META_R1___________________        _______, _______, A(KC_U), _______, _______
#define _________________META_R2___________________        _______, S(A(KC_N)), S(A(KC_E)), S(A(KC_I)), S(A(KC_O))
