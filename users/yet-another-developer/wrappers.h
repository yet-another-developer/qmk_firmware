...
#define _________________NUMFUNC_L1________________        _________________FUNC_LEFT_________________
#define _________________NUMFUNC_L2________________        ________________NUMBER_LEFT________________
#define _________________NUMFUNC_L3________________        ___________________BLANK___________________

#define _________________NUMFUNC_R1________________        _________________FUNC_RIGHT________________
#define _________________NUMFUNC_R2________________        ________________NUMBER_RIGHT_______________
#define _________________NUMFUNC_R3________________        ___________________BLANK___________________


#define _________________HYPER_L1__________________        _______, _______, LCTL(KC_UP), _______, _______
#define _________________HYPER_L2__________________        _______, LCTL(KC_LEFT), LCTL(KC_DOWN), LCTL(KC_RGHT), _______
#define _________________HYPER_L3__________________        ___________________BLANK___________________

#define _________________HYPER_R1__________________        ___________________BLANK___________________
#define _________________HYPER_R2__________________        ___________________BLANK___________________
#define _________________HYPER_R3__________________        ___________________BLANK___________________



#define _________________META_L1___________________        _______, _______, A(KC_F), _______, _______
#define _________________META_L2___________________        _______, _______, _______, A(KC_T), _______
#define _________________META_L3___________________        ___________________BLANK___________________

#define _________________META_R1___________________        ___________________BLANK___________________
#define _________________META_R2___________________        ___________________BLANK___________________
#define _________________META_R3___________________        _______, A(KC_N), A(KC_E), A(KC_I), A(KC_O)
...
#define _________________SUPER_R1__________________        ___________________BLANK___________________
#define _________________SUPER_R2__________________        ___________________BLANK___________________
#define _________________SUPER_R3__________________        ___________________BLANK___________________
// clang-format on
