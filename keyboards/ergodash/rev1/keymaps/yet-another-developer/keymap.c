...
#define LAYOUT_ergodash_pretty_base( \
  ...
  LAYOUT_ergodash_pretty_wrapper( \
      ...
      HY_ESC,LSFT_T(K11),K12,LCTL_T(K13),LALT_T(K14),K15,   NF_ENT,                   NF_CBR,  K16,RALT_T(K17),RCTL_T(K18), K19,RSFT_T(K1A),HY_QUOT, \
     OS_LSFT,LCTL_T(K21),K22,    K23,     K24,     K25,                                        K26,    K27,    K28,    K29,RCTL_T(K2A),     OS_RSFT, \
      KC_LCTL, KC_LGUI, KC_LALT, KC_LALT,                                                                    KC_LEFT, KC_DOWN, KC_UP,       KC_RIGHT, \
                                                  SP_LWER,                                            ET_RAIS,                                        \
                                         OS_LGUI, SP_LWER, MT_DEL,                           SU_BSPC, ET_RAIS,  OS_RGUI                               \
    )
...
// Otherwise, it needs KC_*
  ...
  [_LOWER] = LAYOUT_ergodash_pretty_wrapper(
    ...
    CMD_TAB, _________________LOWER_L2__________________, _______,         _______, _________________LOWER_R2__________________, KC_DQUO,
  ...
  [_NUMFUNC] = LAYOUT_ergodash_pretty_wrapper(
    _______, _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______, _______,
    _______, _________________NUMFUNC_L1________________, _______,         _______, _________________NUMFUNC_R1________________, _______,
    _______, _________________NUMFUNC_L2________________, _______,         _______, _________________NUMFUNC_R2________________, _______,
    _______, _________________NUMFUNC_L3________________,                           _________________NUMFUNC_R3________________, _______,
    _______, _______, _______, _______,                                                               _______, _______, _______, _______,
                                                 _______,                           _______,
                                        _______, _______, _______,         _______, _______, _______
    ),

  [_HYPER] = LAYOUT_ergodash_pretty_wrapper(
    _______, _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______, _______,
    _______, _________________HYPER_L1__________________, _______,         _______, _________________HYPER_R1__________________, _______,
    _______, _________________HYPER_L2__________________, _______,         _______, _________________HYPER_R2__________________, _______,
    _______, _________________HYPER_L3__________________,                           _________________HYPER_R3__________________, _______,
    _______, _______, _______, _______,                                                               _______, _______, _______, _______,
                                                 _______,                           _______,
                                        _______, _______, _______,         _______, _______, _______
    ),

  [_META] = LAYOUT_ergodash_pretty_wrapper(
    _______, _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______, _______,
    _______, _________________META_L1___________________, _______,         _______, _________________META_R1___________________, _______,
    _______, _________________META_L2___________________, _______,         _______, _________________META_R2___________________, _______,
    _______, _________________META_L3___________________,                           _________________META_R3___________________, _______,
    _______, _______, _______, _______,                                                               _______, _______, _______, _______,
                                                 _______,                           _______,
                                        _______, _______, _______,         _______, _______, _______
    ),

  [_SUPER] = LAYOUT_ergodash_pretty_wrapper(
    _______, _______, _______, _______, _______, _______, _______,         _______, _______, _______, _______, _______, _______, _______,
    _______, _________________SUPER_L1__________________, _______,         _______, _________________SUPER_R1__________________, _______,
    _______, _________________SUPER_L2__________________, _______,         _______, _________________SUPER_R2__________________, _______,
    _______, _________________SUPER_L3__________________,                           _________________SUPER_R3__________________, _______,
    _______, _______, _______, _______,                                                               _______, _______, _______, _______,
                                                 _______,                           _______,
                                        _______, _______, _______,         _______, _______, _______
    ),
